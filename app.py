...
# Se usuário estiver logado, exibir uma página inicial com boas-vindas
    ...
    with col1:
        ...
        st.markdown("Analise tendências, compare períodos e obtenha insights sobre suas finanças.")
        st.markdown("<a href='3_relatorios' target='_self' class='custom-button'>Ver Relatórios</a>", unsafe_allow_html=True)
        st.markdown("</div>", unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.markdown("Registre e gerencie suas despesas e receitas com detalhes e categorização.")
